...
## 📌 Course Information
- **Course**: CSC 422/522 – Computer Vision and Pattern Recognition
...
- CNN-based classification, detection, and segmentation
- Depth estimation and 3D reconstruction
- Transformers and foundation models in vision
...
📌 **All rights belong to the instructor and SDSU.**  
📌 These materials are **not redistributed for commercial use**.
